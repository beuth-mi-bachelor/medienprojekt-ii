...
public class GameActivity extends Activity implements PlayerEventListener , NanostreamEventListener {
   ...
   // private MediaController controller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SurfacePlayerView surfaceView1 = (SurfacePlayerView) findViewById(R.id.view);
        surfaceView1.getHolder().addCallback(player);

        root = (LinearLayout) findViewById(R.id.gamescreen_guesser);
