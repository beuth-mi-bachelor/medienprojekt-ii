...
import net.nanocosmos.nanoStream.streamer.nanoStream.VideoSourceType;
import net.nanocosmos.nanoStream.ui.StreamPreview;
import net.nanocosmos.nanoStream.util.PreferenceEnum;
import net.nanocosmos.nanoStream.util.VideoCamera;
...
public class MainActivity extends FragmentActivity implements NanostreamEventListener
{
	...
	private VideoSourceType vsType = VideoSourceType.EXTERNAL;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		try
		{
			...
			mVideoCam.startCamera(CameraInfo.CAMERA_FACING_BACK);
	...
	{
		Toast.makeText(this, "nanoStream-Version : " + nanoStream.getVersion().fullVersion, Toast.LENGTH_LONG).show();
	}

	/**
	 * "OnClick"-Methode f�r den "Settings"-Men�-Eintrag.
	 * 
	 * @param clicked
	 *            - Der geclickte Menu-Eintrag.
	 */
	public void showSettings(MenuItem clicked)
	{
		...
		Toast.makeText(getApplicationContext(), "Showing Settings...", Toast.LENGTH_LONG).show();
		Intent intent = new Intent(this, PreferenceActivity.class);

		intent.putExtra("de.nanocosmos.streamer.VideoEncoder.resolutions", streamLib.getCapabilities().listAvailableVideoResolutions());
		intent.putIntegerArrayListExtra("de.nanocosmos.streamer.VideoEncoder.fps", (ArrayList<Integer>) streamLib.getCapabilities()
