...
public class PlayerActivity extends Activity implements PlayerEventListener
{
    ...
    private static final String strStreamUrl = "rtmp://ws2.nanocosmos.net/vod";
	...
	{
		if (event.GetType() == NanostreamEvent.TYPE_RTMP_STATUS && event.GetCode() == NanostreamEvent.CODE_STREAM_STARTED)
		{
			Log.d("TEST", "EVENT");
